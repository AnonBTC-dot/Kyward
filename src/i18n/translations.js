  ...
  en: {
    ...
    legal: {
      privacy: {
        ...
        cookiesText: 'We use minimal, privacy-respecting analytics tools: Vercel Analytics (aggregated, anonymous page-view data) and the X (Twitter) Ads pixel to measure the performance of our advertising campaigns. No personal data is shared with these tools beyond what is standard for conversion tracking. We also use essential session cookies required for the website to function (session management, language preferences). You can disable third-party scripts via your browser settings.',
  ...
  es: {
    ...
    legal: {
      privacy: {
        ...
        cookiesText: 'Usamos herramientas de analítica mínimas y respetuosas de la privacidad: Vercel Analytics (datos de páginas vistas anónimos y agregados) y el píxel de X (Twitter) Ads para medir el rendimiento de nuestras campañas publicitarias. No se comparten datos personales con estas herramientas más allá de lo estándar para el seguimiento de conversiones. También usamos cookies de sesión esenciales requeridas para que el sitio web funcione (gestión de sesión, preferencias de idioma). Puedes deshabilitar scripts de terceros desde la configuración de tu navegador.',
